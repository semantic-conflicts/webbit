...
public class WebSocketClient implements WebSocket {
  public static String ACCEPT_GUID="258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
  public static MessageDigest SHA_1;
static {
    try {
  ...
  public String base64Nonce;
  public Thread.UncaughtExceptionHandler exceptionHandler;
  public Thread.UncaughtExceptionHandler ioExceptionHandler;
  ...
  /** 
 * What to do when an exception gets thrown in a handler. <p/> Defaults to using  {@link org.webbitserver.handler.exceptions.PrintStackTraceExceptionHandler}. It is suggested that apps supply their own implementation (e.g. to log somewhere).
 */
  ...
  /** 
 * What to do when an exception occurs when attempting to read/write data from/to the underlying connection. e.g. If an HTTP request disconnects before it was expected. <p/> Defaults to using  {@link org.webbitserver.handler.exceptions.SilentExceptionHandler}as this is a common thing to happen on a network, and most systems should not care.
 */
  ...
  @Override public WebSocketClient start(){
  ...
  public HttpRequest createNettyHttpRequest(  String uri,  String host){
  ...
  @Override public WebSocket close(){
  ...
  @Override public WebSocketClient reconnectEvery(  long reconnectIntervalMillis){
    webSocketHandler=new ReconnectingWebSocketHandler(webSocketHandler,WebSocketClient.this,reconnectIntervalMillis);
    return this;
  }
public class HandshakeChannelHandler extends SimpleChannelUpstreamHandler {
    public byte[] outboundMaskingKey;
    ...
    public void verifySecWebSocketAccept(    String webSocketAccept){
    ...
    public void adjustPipelineToWebSocket(    ChannelHandlerContext ctx,    MessageEvent messageEvent,    ChannelHandler webSocketFrameDecoder,    ChannelHandler webSocketFrameEncoder){
    ...
    public HandshakeChannelHandler(){
    }
  }
